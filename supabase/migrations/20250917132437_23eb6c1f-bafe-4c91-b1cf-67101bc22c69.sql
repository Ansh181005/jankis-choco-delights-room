...
-- 1. Fix the buggy conversation_participants RLS policy
...
-- 2. Add database constraints for security and data integrity
-- Add CHECK constraints for contacts table
...
-- 3. Add trigger to automatically assign first admin role
